...
项目当前已完成开发流程第 12 步“知识点和功法进度”的基础接入。
...
```text
已实现跨记录基础汇总、知识点进度封顶和功法层数基础判定，但个人境界突破仍在后续步骤
当前仅保存修炼记录和记录-知识点关联，默认门派、功法和知识点仍来自静态数据
功法层数规则当前由 AI 默认草案静态生成，用户自定义规则配置留到第 16 步
突破要求当前先以文本要求展示，后续事件系统成熟后再和事件/成果记录绑定
